                    ...
                    <main>
                        ...
                        <Card title="Flock Details">
                            <div className="d-flex align-items-center">
                                <Image src={flockData.imageUrl} width="150" height="150" className="flock-image"/>
                                <div className="ms-4">
                            ...
                            <div>
                                ...
                                {
                                    flockData.chickens.map(breed => {
                                        return (
                                            <div className="d-flex align-items-center breed">
                                                <Image src={breed.imageUrl} width="50" height="50" className="flock-image" />
                                                <div className="ms-3">
                                                    <p>
